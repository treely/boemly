...
export const Texts = () => (
  <div>
    <Text size="xlRegularNormal">Text - size: xlRegularNormal</Text>
    ...
    <br />
    <Text size="xlRegularNormalBold">Text - size: xlRegularNormalBold</Text>
    ...
    <br />
    <Text size="xlLowNormal">Text - size: xlLowNormal</Text>
    ...
    <br />
    <Text size="xlLowBold">Text - size: xlLowBold</Text>
    ...
    <br />
    <Text size="xlMonoNormal">Text - size: xlMonoNormal</Text>
    ...
    <br />
    <Text size="xlMonoUppercase">Text - size: xlMonoUppercase</Text>
